    ...
    <div className={styles.pageLayout}>
      ...
      {activeTab === 'overview' && (
        <div className={styles.contentScroll}>
          ...
          <p>
            液奶过程监控系统 (FT1-MONITOR) 是一套面向乳制品生产过程的实时 SPC 分析与智能预警平台。系统集成多源仪器数据自动采集、统计过程控制 (SPC) 分析、过程能力评估、AI 指标预测和分级预警功能，帮助质量管理人员实时掌握生产过程稳定性，将质量管控从"事后检验"升级为"实时监控、智能预警、主动预防"。
          </p>
          <p>
